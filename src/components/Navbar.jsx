...
const Navbar = () => {
  ...
  const whitePaths = ['/contact', '/products'];
  const isWhiteLogo =
    whitePaths.includes(location.pathname) ||
  ...
  return (
    <>
        ...
        <div className="w-full flex justify-between items-center gap-2">
          ...
          >
            ...
            >
              <PhoneIcon />
              <span
                className="font-medium unicode-bidi-bidi-override"
                dir="ltr"
              >
                021 2310 379
              </span>
            ...
            >
              <MailIcon />
              <span className="font-medium font-[Expo-arabic]">
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              className="hover:text-[#E2995E] transition"
            >
              <FacebookIcon />
            </Link>
            <Link
      ...
      >
        ...
        <nav className="hidden lg:flex gap-8 mr-10 font-[Expo-arabic] items-center text-lg">
          <NavLink
            to="/"
            className={({ isActive }) =>
              clsx(
            ...
            >
              ...
              >
                ...
                {i18n.language === 'ar' ? (
                  <ChevronLeftIcon
                    color="white"
                    className="text-primary duration-150 sm:scale-100"
                  />
                ) : (
                  <ChevronRightIcon
                    color="white"
                          ...
                          {cartData.data.length === 0 ? (
                            ...
                            <>
                              {cartData.data.map((item) => (
                                <div
                                  key={item.id}
                                  className="grid grid-cols-3 gap-4 mb-3 items-center"
                                >
                                  <img
                                    src={item.image}
                                  ...
                                  <div className="relative flex items-center border rounded-2xl bg-white text-[#025043] px-1 py-1">
                                    ...
                                    <button
                                      ...
                                      className="p-1 bg-[#025043] text-white rounded-lg cursor-pointer scale-75"
                                    >
                                      <PlusIcon />
                                    </button>
                              ...
                              <Link to="/checkouts">
                                <button
                                  onClick={() => setIsCartOpen(false)}
                                  className="text-[#025043] border rounded-2xl cursor-pointer bg-white font-[Expo-arabic] py-2 w-full flex justify-center hover:bg-gray-100 transition-colors"
                                >
                                  {t('cart.checkout')}
                                </button>
                              </Link>
