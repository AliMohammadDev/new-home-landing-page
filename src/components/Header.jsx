...
const Header = () => {
  ...
  const slides = [
    {
      image:
        'https://res.cloudinary.com/dzvrf9xe3/image/upload/v1774509451/keukengerei_toms6y.webp',
    ...
    {
      image:
        'https://res.cloudinary.com/dzvrf9xe3/image/upload/v1770449592/pexels-cihanyuce-12181753_um1xu1.jpg',
    ...
    {
      image:
        'https://res.cloudinary.com/dzvrf9xe3/image/upload/v1770449580/pexels-rdne-4910217_zddfm8.jpg',
    ...
    {
      image:
        'https://res.cloudinary.com/dzvrf9xe3/image/upload/v1770449578/pexels-polina-kovaleva-5644353_y67gih.jpg',
    ...
    {
      image:
        'https://res.cloudinary.com/dzvrf9xe3/image/upload/v1774509648/stainless-steel-kitchenware-table_qb7kim.jpg',
  ...
  return (
    <div className="w-full h-[110vh] md:h-screen relative overflow-hidden bg-black">
      <Swiper
        ...
        className="h-full my-Swiper  w-full"
      >
              ...
              >
                ...
                >
                    ...
                    className={clsx(
                      ...
                      isActive
                        ...
                        : isRTL
                          ...
                          : '-translate-x-10 opacity-0',
                      isRTL
                        ? 'pr-11 sm:pr-8 md:pr-12 font-[Expo-arabic]'
                        : 'pl-11 sm:pl-8 md:pl-12 font-[Qanduchia]'
                    )}
                  >
                    <h1
                      className={clsx(
                  ...
                  >
                    <div
                      className={clsx(
                        'flex flex-wrap items-baseline gap-3 justify-start'
                      )}
                    >
                  ...
                  <div
                    className={clsx(
                      ...
                      isActive
                        ...
                        : 'translate-y-10 opacity-0',
                      isRTL
                        ? 'mr-6 sm:mr-16 md:mr-40'
                        : 'ml-6 sm:ml-16 md:ml-40'
                    )}
                  >
                    <a
                      href="products"
