      ...
      <div className="flex flex-col lg:flex-row w-full items-stretch overflow-hidden border-t">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-5">
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-2 text-white/40 mb-1">
                      ...
                      <span className="text-[14px] uppercase tracking-widest">{t('footer.mobile')}</span>
                    </div>
                    {[
                      ...
                      <a key={idx} href={`tel:${num.tel}`} className="text-lg font-light hover:text-[#E2995E] transition tracking-wider flex items-center gap-3 group" dir="ltr">
                  ...
                  <div className="pt-4 border-t border-white/5 flex flex-col gap-2">
                    <div className="flex items-center gap-2 text-white/40 mb-1">
                      <PhoneIcon size={14} />
                      <span className="text-[14px] uppercase tracking-widest">{t('footer.landline')}</span>
                    </div>
                    <a href="tel:0212310379" className="text-lg font-light hover:text-[#E2995E] transition tracking-wider flex items-center gap-3 group" dir="ltr">
              ...
              <div className="flex flex-col pt-4 border-t border-white/5">
                ...
                <p className="text-base opacity-90 leading-relaxed font-[Expo-book]">
                  ...
                  <span className="text-white/60 text-sm">{t('footer.address_line2')}</span>
                </p>
              </div>
              ...
              <div className="flex gap-3 pt-6 border-t border-white/5">
                {[
                  ...
                  <a key={i} href={social.href} className="w-9 h-9 flex items-center justify-center bg-white/5 hover:bg-[#E2995E] rounded-lg transition-all border border-white/10">
                    {social.icon}
                  </a>
                ))}
              </div>
        ...
        <div className="w-full lg:w-[60%] min-h-[500px] lg:min-h-full p-10 md:p-12 lg:p-16">
          <div className="w-full h-full rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3224.5428!2d37.1611!3d36.2021!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzbCsDEyJzA3LjYiTiAzN8KwMDknNDAuMCJF!5e0!3m2!1sen!2ssy!4v1630000000000!5m2!1sen!2ssy"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
