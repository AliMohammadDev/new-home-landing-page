          ...
          <>
            ...
            >
              {variants.map((variant) => {
                ...
                const sizes = [
                  ...new Set(
                    variant.product?.available_options?.flatMap((c) =>
                ...
                const materials = [
                  ...new Set(
                    variant.product?.available_options?.flatMap(
                      (c) =>
                    ...
                    <div className="bg-[#EDEAE2] rounded-xl overflow-hidden border border-[#D8D5CD] flex flex-col h-[500px] shadow-sm hover:shadow-md transition-all group">
                      ...
                      <div className="relative overflow-hidden">
                        {discountVal > 0 && (
                          ...
                          >
                            {isRTL
                              ? `${t('essential_to_prep.off')} ${discountVal}%`
                              : `${discountVal}% ${t('essential_to_prep.off')}`}
                          </div>
                        )}
                        <Link
                          to={`/products/${categoryId}/product-info/${variant.id}`}
                        >
                          <img
                            src={variant.image}
                            alt={variant.sku}
                      ...
                      <div className="p-4 flex flex-col gap-2 flex-1">
                        <h3
                          className={`text-[#025043] text-[16px] font-bold -mb-6 h-12 overflow-hidden ${isRTL ? 'font-[Expo-arabic] text-right' : 'font-[Expo-book] text-left'}`}
                        >
                        ...
                        >
                          <span className="text-[#025043] text-lg font-bold font-[Expo-arabic]">
                            {variant.final_price} $
                          </span>
                          {discountVal > 0 && (
                            <span className="text-gray-400 text-xs line-through decoration-red-500/40">
                              {variant.price} $
                            </span>
                          )}
                        </div>
